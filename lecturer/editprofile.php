...
$index_number = $_POST['id'];
$select = 'SELECT *from lecturer WHERE id = "'.$index_number.'"';
	...
	<section>
		...
		<div class="edit">
		  ...
		  <form action="edit.php" method="post">
		  	...
		  	<tr><p>
		  		<td>Lecturer ID</td> <td><input type="text" name="indexnumber" value="'.$fetch["id"].'" required=""></td>
		  	</p>
		  </tr>
		  <tr><p>
		  		<td>Password</td> <td><input type="password" name="password" value="'.$fetch["password"].'" required=""></td>
		  	</p>
		  </tr>
		  		<tr><p>
		  		<td>Email</td> <td><input type="email" name="email" value="'.$fetch["email"].'" required=""></td>
					<input type="text" name="number" value="'.$fetch["id"].'" required="" style="visibility:hidden;">
		  	</p>
		  </tr>
